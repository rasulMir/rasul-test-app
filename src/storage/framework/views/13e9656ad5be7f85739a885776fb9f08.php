...
unset($__errorArgs, $__bag); ?>" id="name"
                            name="name" placeholder="Иван" value="<?php echo e($client->name); ?>">
...
unset($__errorArgs, $__bag); ?>" id="surname"
                            name="surname" placeholder="Иванов" value="<?php echo e($client->surname); ?>">
...
unset($__errorArgs, $__bag); ?>" id="phone"
                            name="phone" placeholder="998337117135" value="<?php echo e($client->phone); ?>">
                        <small id="phone" class="form-text text-muted">
                            Введите номер телефона клиента.<?php echo e($client->phone); ?>
...
unset($__errorArgs, $__bag); ?>" id="points"
                            name="points" placeholder="100" value="<?php echo e($client->points); ?>">
...
unset($__errorArgs, $__bag); ?>" id="email"
                            name="email" placeholder="test@example.com" value="<?php echo e($client->email); ?>">
                        <small id="points" class="form-text text-muted">
...
unset($__errorArgs, $__bag); ?>" id="birth_date"
                            name="birth_date" value="<?php echo e($client->birth_date->format('Y-m-d')); ?>">
...
<?php echo $__env->make('main.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/resources/views/clients/client-edit.blade.php ENDPATH**/ ?>